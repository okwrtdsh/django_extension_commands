...
```bash
python manage.py create_object_diagram -aAPd
```

```
@startuml
package django_contrib_admin_models{
  object LogEntry
}
package django_contrib_auth_models{
  object AbstractUser
}
package django_contrib_auth_models{
  object Permission
...
package django_contrib_contenttypes_models{
  object ContentType
}
package django_contrib_sessions_models{
  object Session
}
package attendance_schedule_staff_models{
  object AbstractSchedule
}
package attendance_schedule_staff_models{
  object Staff
}
